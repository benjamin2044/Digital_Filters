...
float R = 40, Q = 1e-1;  //Q = process noise covariance, R = measurement noise covariance
...
double Pp1 = 0.0, P0 = 0; //Pp1 = error covariance at t=1, P0 = error covariance at t=0
...
void loop() {
 ...
 Ppe0 = Pp1 + Q; //Assumption or prediction 2
 ...
 Pp1 = P0; //Update: current t=0 becomes t=1 in the next step
 delay(50);
}
